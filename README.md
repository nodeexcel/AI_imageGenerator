...
Welcome to the AI Image Generator project! This application harnesses OpenAI's technology to create images from textual descriptions.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/nodeexcel/AI_imageGenerator.git
   cd node-project
